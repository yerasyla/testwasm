...
func New(
	...
	*/
	...
	app.TestwasmKeeper = *testwasmmodulekeeper.NewKeeper(
		appCodec,
		keys[testwasmmoduletypes.StoreKey],
		keys[testwasmmoduletypes.MemStoreKey],
		app.GetSubspace(testwasmmoduletypes.ModuleName),
	)
